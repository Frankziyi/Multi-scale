...
DATASET_DIR=/world/data-gpu-94/sysu-reid/person-reid-data/DukeMTMC-reID-tfrecord-Rect/bounding_box_train
...
--pretrain_branch_0_path=${PRETRAINED_CHECKPOINT_DIR}/Duke_inception_320_160/model.ckpt-58578 \
--pretrain_branch_1_path=${PRETRAINED_CHECKPOINT_DIR}/Duke_inception_256_128/model.ckpt-49532
