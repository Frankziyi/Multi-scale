...
CKPT_SAVE_DIR=/world/data-gpu-94/sysu-reid/checkpoints/Market_inception_multi_rect
...
--pretrain_branch_0_path=${PRETRAINED_CHECKPOINT_DIR}/Market_inception_320_160/model.ckpt-50808 \
--pretrain_branch_1_path=${PRETRAINED_CHECKPOINT_DIR}/Market_inception_256_128/model.ckpt-57155
